...
function DashboardForVolunteer() {
  ...
  // Load logged-in Volunteer profile
  useEffect(() => {
    ...
    <div className="dashboard-container">
      ...
      <nav className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <ul className="nav-list">
          ...
          <li className={isActive('/dashboard/find-oppurt') ? 'active' : ''}>
            <Link to="/dashboard/find-oppurt" onClick={handleLinkClick}>
              <FaBriefcase /> <span>Find Opportunities</span>
            </Link>
          </li>

          <li className={isActive('/dashboard/my-applications') ? 'active' : ''}>
